...
import 'package:interview/features/tour_builder/bloc/tour_builder_event.dart';
...
class TourBuilderPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => context.read<TourBuilderBloc>(),
      child: Scaffold(
        appBar: AppBar(title: const Text('Create a tour')),
        body: Stack(
          children: [
